...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Ken Kaneki\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6285718084553:+62 857-1808-4553\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '.'
limitawal = 30
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6285718084553@s.whatsapp.net","6285718084553@s.whatsapp.net"] 
/************************************/
		...
		case 'ohidetag':
            ...
            if (!isOwner) return reply(ind.ownerb())
					...
					if ((args[0]) === '1') {
						...
						reply('❬ 𝗦𝗨𝗞𝗦𝗘𝗦 ❭ 𝗠??𝗻𝗴𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗳𝗶𝘁𝘂𝗿 𝘄𝗲𝗹𝗰𝗼𝗺𝗲/𝗹𝗲𝗳𝘁 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 𝗶𝗻𝗶️')
					} else if ((args[0]) === '0') {
